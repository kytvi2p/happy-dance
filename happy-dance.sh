...
# Requirements:
#     - OpenSSH 6.5 or above.
#     - Root or sudo if changing system configuration (client or server)
#
...
# - Ubuntu 14.04 & 15.04 (12.04 will work with a PPA according to
#   https://github.com/NSAKEY/happy-dance/issues/1#issuecomment-128469412)
# - CentOS 7
